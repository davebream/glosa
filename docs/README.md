...
| `appendices/A1-api-transport.md` | Normative: HTTP contract 1.15, metadata, watcher health, attention, dictation grants, streaming-SSE, capability URLs, versioning. |
...
| `release.md` | How a release reaches people: the Homebrew cask for the desktop app, its tap and how it is bumped. |
