...
- ✅ **P4.5 jethro adapter** — **SUPERSEDED by P6.1 (done as the generic fixture-protocol version — see Phase 6).** Not built as originally specified; no ⬜ action remains here.
