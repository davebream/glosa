...
// Vendored verbatim from `idiomorph@0.8.0`'s `dist/idiomorph.esm.js` (the `idiomorph` npm
...
// uses. To pick up a new idiomorph release: `bun add idiomorph@<version>`, then re-copy
// `node_modules/idiomorph/dist/idiomorph.esm.js` over this file (keeping this header).
/**
