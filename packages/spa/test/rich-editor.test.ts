...
describe("the REQ-8 measurement harness (AC-4) — four metrics over the nine hand-written documents", () => {
  ...
  test("metric 1 — 46 of 717 blocks still cost bytes re-serialized, with no restoration", () => {
    ...
    expect(misses).toBeLessThanOrEqual(46);
    ...
    // (39 → 40), plus `## [0.1.0-alpha.23]`, which alpha.23 gave a link definition (40 → 41), plus `## [0.1.0-alpha.24]`, which alpha.24 gave a link definition (41 → 42), plus #270's own `## [Unreleased]` heading, whose definition was already at the foot of the file (42 → 43), plus #271's, for the same reason (43 → 44), plus `## [0.1.0-alpha.28]`, which alpha.28 gave a link definition (44 → 45), plus the `## [Unreleased]` heading opened for the next release, whose definition is already at the foot of the file (45 → 46). A genuine
  ...
  test("metrics 2 and 3 — 1 dishonest write of 652; the guard fires on it and, ablated, on 41", () => {
