...
describe("the REQ-8 measurement harness (AC-4) — four metrics over the nine hand-written documents", () => {
  ...
  test("metric 1 — 40 of 487 blocks still cost bytes re-serialized, with no restoration", () => {
  ...
  // Give all 435 edits a bounded budget; no cases or fidelity assertions are skipped.
  test("metrics 2 and 3 — 1 dishonest write of 435; the guard fires on it and, ablated, on 35", () => {
