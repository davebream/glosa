...
describe("the REQ-8 measurement harness (AC-4) — four metrics over the nine hand-written documents", () => {
  ...
  // two paragraphs, all editable: 762 blocks / 692 edits; then AGENTS.md's copy rule, one paragraph: 763 / 693. Numerators unmoved.
  ...
  test("metric 1 — 49 of 763 blocks still cost bytes re-serialized, with no restoration", () => {
  ...
  test("metrics 2 and 3 — 1 dishonest write of 693; the guard fires on it and, ablated, on 44", () => {
