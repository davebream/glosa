...
describe("the REQ-8 measurement harness (AC-4) — four metrics over the nine hand-written documents", () => {
   ...
   *  failure itself. */
  // #145 adds one README paragraph: 488 blocks / 436 edits. All failure causes and
  ...
  test("metric 1 — 40 of 488 blocks still cost bytes re-serialized, with no restoration", () => {
  ...
  // Give all 436 edits a bounded budget; no cases or fidelity assertions are skipped.
  test("metrics 2 and 3 — 1 dishonest write of 436; the guard fires on it and, ablated, on 35", () => {
